...
// Absolute Beginners's Guide to C, 3rd Edition
// File Chapter9ex1.c
...
int	main(void)
{
	...
	// Usint two float variables creates an answer of 3.8
	floatAnswer = a / b;
	printf("%.1f divided by %.1f equals %.1f\n", a, b, floatAnswer);

	// Use the % (Modulus) operator only on integers
	// floatAnswer = a % b;
	// printf("%.1f divided by %.1f equals %.1f\n", a, b, floatAnswer);
	...
	// This will also be 3, as it turncates and doesn't round up
	intAnswer = a / b;
